...
// 問題のクラス
class Question {
    constructor(num, name, correct, incrrect1, incrrect2, img) {
        this.name = name;
...
// 選択肢のクラス
class Choice {
    constructor(choiceNum, selectContent, isCorrect, questionNum){
...
// 問題を生成
const takanawa = new Question(1, "高輪", "たかなわ", "こうわ", "たかわ", "takanawa.png");
const kameido = new Question(2, "亀戸", "かめいど", "かめど", "かめと", "kameido.png");
const koujimachi = new Question(3, "麹町", "こうじまち", "おかとまち", "かゆまち", "koujimachi.png");
const onarimon = new Question(4, "御成門", "おなりもん", "おかどもん", "ごせいもん", "onarimon.png");
const todoroki = new Question(5, "等々力", "とどろき", "たたら", "たたりき", "todoroki.png");
const shakuji = new Question(6, "石神井", "しゃくじい", "いじい", "せきこうい", "shakuji.png");
const zoushiki = new Question(7, "雑色", "ぞうしき", "ざっしょく", "ざっしき", "zoushiki.png");
const okachimachi = new Question(8, "御徒町", "おかちまち", "ごしろちょう", "みとちょう", "okachimachi.png");
const shishibone = new Question(9, "鹿骨", "ししぼね", "しこね", "ろっこつ", "shishibone.png");
const kogure = new Question(10, "小榑", "こぐれ", "こしゃく", "こばく", "kogure.png");
